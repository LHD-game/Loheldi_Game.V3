...
public class QuestScript : MonoBehaviour
{
    ...
    public void QuestChoice()
    {
        ...
        else if (DontDestroy.QuestIndex.Equals("13_1")|| DontDestroy.QuestIndex.Equals("16_1")|| DontDestroy.QuestIndex.Equals("21_1")|| DontDestroy.QuestIndex.Equals("23_1"))
        {
            //미량 영양소, 줄넘기, 음악의 힘, 내 삶의 주인되기, 건강해진 내 모습
            //캐릭터 플레이어 집 앞으로 데려오기
